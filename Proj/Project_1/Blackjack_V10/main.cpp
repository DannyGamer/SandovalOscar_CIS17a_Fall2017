 ...
 * Created on November 5th, 2017, 9:03 PM
 * Purpose: Game of Blackjack Version 10
 */
...
int main(int argc, char** argv) {
    ...
    {      
        ...
        //Reset each card of each suit back to 4
        for (int i = 0; i < 13; i++)
    ...
    //Delete dynamically allocated structure array
    delete [] player;
    player = 0;
...
void rules()
{
    ...
    cout << "The goal of the game is to see who can get the closest to "
            "the number 21,\nwith any combination of cards you have. " << endl;
